  ...
  <div class="app-container">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="集装箱位置" prop="containerLocation">
          <el-input
            v-model="form.containerLocation"
            placeholder="请输入集装箱位置"
          />
        </el-form-item>
        <el-form-item label="集装箱状态" prop="containerStatus">
          <el-input
...
<script>
import { listContainer, getContainer, delContainer, addContainer, updateContainer } from "@/api/containerinfo/container";
