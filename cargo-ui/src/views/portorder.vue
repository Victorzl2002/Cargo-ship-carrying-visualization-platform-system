 ...
 * @LastEditTime: 2024-01-17 18:40:16
 * @Description: 请填写简介
-->
<template>
...
<script>
import { listOrder1, getOrder, delOrder, addOrder, updateOrder } from "@/api/order/order";
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listOrder1(this.queryParams).then(response => {
