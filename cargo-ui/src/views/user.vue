...
"
      ...
      <el-form-item label="余额" prop="walletBalance">
        <el-input
...
"
      ...
      <el-table-column label="余额" align="center" prop="walletBalance" />
      <el-table-column
        label="操作"
        align="center"
...
"
        ...
        <el-form-item label="身份" prop="userIdentity">
          <el-input v-model="form.userIdentity" placeholder="请输入身份" />
        </el-form-item>
        <el-form-item label="手机号" prop="phoneNumber">
          <el-input v-model="form.phoneNumber" placeholder="请输入手机号" />
        </el-form-item>
        <el-form-item label="余额" prop="walletBalance">
          <el-input v-model="form.walletBalance" placeholder="请输入余额" />
        </el-form-item>
      </el-form>
