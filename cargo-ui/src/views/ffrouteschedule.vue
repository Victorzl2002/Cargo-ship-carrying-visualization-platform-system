<!--
 * @Author: Victorzl
 * @Date: 2024-01-17 11:51:01
 * @LastEditors: Victorzl
 * @LastEditTime: 2024-01-17 12:34:47
 * @Description: 请填写简介
-->
<!--
 * @Author: Victorzl
 ...
 * @LastEditors: Victorzl
 * @LastEditTime: 2024-01-16 10:11:43
 * @Description: 请填写简介
-->
<template>
...
<script>
import { listRouteschedule, getRouteschedule, delRouteschedule, addRouteschedule1, updateRouteschedule } from "@/api/routeschedule/routeschedule";
      ...
      this.$refs["form"].validate(valid => {
        if (valid) {
          if (this.form.routescheduleId != null) {
            ...
            addRouteschedule1(this.form).then(response => {
