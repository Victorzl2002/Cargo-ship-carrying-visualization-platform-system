 ...
 * @LastEditTime: 2023-12-30 16:56:58
 * @Description: 请填写简介
-->
<template>
...
<script>
import { listRouteschedule1, getRouteschedule, delRouteschedule, addRouteschedule, updateRouteschedule } from "@/api/routeschedule/routeschedule";
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listRouteschedule1(this.queryParams).then(response => {
