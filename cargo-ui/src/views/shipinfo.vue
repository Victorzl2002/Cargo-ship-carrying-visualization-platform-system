 ...
 * @LastEditTime: 2024-01-16 10:30:21
 * @Description: 请填写简介
-->
<template>
  <div class="app-container">
    <el-form
      ...
      label-width="68px"
    >
      <el-form-item label="船运公司" prop="companyId">
        <el-input
          v-model="queryParams.companyId"
          placeholder="请输入船运公司id"
          clearable
    ...
    >
      ...
      <el-table-column label="船运公司id" align="center" prop="companyId" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="船运公司id" prop="companyId">
          <el-input v-model="form.companyId" placeholder="请输入船运公司id" />
        </el-form-item>
        <el-form-item label="船舶名称" prop="shipName">
...
<script>
import { listShip, getShip, delShip, addShip, updateShip } from "@/api/ship/ship";
