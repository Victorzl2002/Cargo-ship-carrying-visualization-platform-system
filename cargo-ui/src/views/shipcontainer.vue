 ...
 * @LastEditTime: 2024-01-18 19:42:34
 * @Description: 请填写简介
-->
<template>
...
<script>
import { listContainer2, getContainer, delContainer, addContainer2, updateContainer } from "@/api/containerinfo/container";
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listContainer2(this.queryParams).then(response => {
      ...
      this.$refs["form"].validate(valid => {
        if (valid) {
          if (this.form.containerId != null) {
            ...
            addContainer2(this.form).then(response => {
